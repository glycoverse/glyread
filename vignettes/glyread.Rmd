...
- **`read_glyco_decipher()`**: Glyco-Decipher's identification and label-free quantification
- **`read_strucgp()`**: StrucGP's identification

**Coming Soon to a Package Near You:**
We're actively working on supporting GPQuest, GlycanFinder and other exciting tools.
...
**🎯 Special Note on Those Last Two:** The `glycan_composition` and `glycan_structure` columns 
aren't just plain text—they're sophisticated data types from the amazing [glyrepr](https://github.com/glycoverse/glyrepr) package.
