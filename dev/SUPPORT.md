...
Thanks for using glyread! Before filing an issue, there are a few places
...
- If it’s a bug: you’re in the right place, [file an
  issue](https://github.com/glycoverse/glyread/issues/new).
...
requests](https://github.com/glycoverse/glyread/issues) to make sure the
