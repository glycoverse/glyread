...
This outlines how to propose a change to glyread. For a detailed
...
- Fork the package and clone onto your computer. If you haven’t done
  ...
  `usethis::create_from_github("glycoverse/glyread", fork = TRUE)`.
...
Please note that the glyread project is released with a [Contributor
Code of
Conduct](https://glycoverse.github.io/glyread/dev/CODE_OF_CONDUCT.md).
